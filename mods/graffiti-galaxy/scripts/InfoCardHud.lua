...
function onCreatePost()
    ...
    -- else
        ...
        -- else
            NewCardHudText('Score', '0', 999, 576, 622, 'left', 19);
            NewCardHudText('Accuracy', '?', 999, 576, 648, 'left', 19);
            NewCardHudText('Misses', '0 Misses', 999, 576, 674, 'left', 19);
            NewCardHudText('MissRating', '', 999, -215, 674, 'right', 19);
            NewCardHudText('AccRating', '', 999, -215, 648, 'right', 19);
        -- end
    -- end
    ...
    setProperty('healthBar.x', 343);
    setProperty('healthBar.y', 580); -- 580 / 730
    ...
    setProperty('timeBar.x', 444);
    setProperty('timeBar.y', 701.2);
    ...
    setProperty('timeTxt.x', 440);
    setProperty('timeTxt.y', 690);
    setProperty('timeTxt.scale.x', 0.85);
    setProperty('timeTxt.scale.y', 0.6);
    setProperty('healthTxt.y', 2000);
    setObjectCamera('healthBar', 'infocard');
    setObjectCamera('timeBarBG', 'infocard');
    setObjectCamera('timeBar', 'infocard');
    setObjectCamera('timeTxt', 'infocard');
end
